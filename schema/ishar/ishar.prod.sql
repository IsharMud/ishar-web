...
) ENGINE=InnoDB AUTO_INCREMENT=57003 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `account_backup` (
  ...
  `beta_tester` tinyint(4) DEFAULT 0
...
) ENGINE=InnoDB AUTO_INCREMENT=31360 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `affect_flags` (
  ...
  `is_beneficial` tinyint(4) DEFAULT 0,
...
CREATE TABLE `class_skills` (
  ...
  `auto_learn` tinyint(4) DEFAULT 0,
...
) ENGINE=InnoDB AUTO_INCREMENT=864626 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=402209148 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=729468 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=70336 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=2353453 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3274377 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `object_wearable_flags` (
  ...
  `WIELD` tinyint(4) NOT NULL DEFAULT 0,
  `HOLD` tinyint(4) NOT NULL DEFAULT 0,
  `TWO_HANDS` tinyint(4) NOT NULL DEFAULT 0,
  `BODY` tinyint(4) NOT NULL DEFAULT 0,
  `HEAD` tinyint(4) NOT NULL DEFAULT 0,
  `NECK` tinyint(4) NOT NULL DEFAULT 0,
  `CHEST` tinyint(4) NOT NULL DEFAULT 0,
  `BACK` tinyint(4) NOT NULL DEFAULT 0,
  `ARMS` tinyint(4) NOT NULL DEFAULT 0,
  `WRIST` tinyint(4) NOT NULL DEFAULT 0,
  `HANDS` tinyint(4) NOT NULL DEFAULT 0,
  `FINGER` tinyint(4) NOT NULL DEFAULT 0,
  `WAIST` tinyint(4) NOT NULL DEFAULT 0,
  `LEGS` tinyint(4) NOT NULL DEFAULT 0,
  `FEET` tinyint(4) NOT NULL DEFAULT 0,
  `ABOUT` tinyint(4) NOT NULL DEFAULT 0,
  `SHIELD` tinyint(4) NOT NULL DEFAULT 0,
  `FACE` tinyint(4) NOT NULL DEFAULT 0,
  `MOUTH` tinyint(4) NOT NULL DEFAULT 0,
  `FORE_MARK` tinyint(4) NOT NULL DEFAULT 0,
  `UPPER_BODY` tinyint(4) NOT NULL DEFAULT 0,
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`object_vnum`),
...
CREATE TABLE `player_affects` (
  ...
  KEY `affect_id` (`affect_id`),
  CONSTRAINT `player_affects_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`) ON DELETE CASCADE,
  CONSTRAINT `player_affects_ibfk_2` FOREIGN KEY (`affect_id`) REFERENCES `skills` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=205762 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=1876142 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=97372 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `player_stats_backup`
--
...
CREATE TABLE `player_stats_backup` (
  `player_stats_id` int(10) unsigned NOT NULL DEFAULT 0,
  `player_id` int(10) unsigned DEFAULT NULL,
  `total_play_time` int(10) unsigned DEFAULT NULL,
  `remort_play_time` int(10) unsigned DEFAULT NULL,
  `total_deaths` mediumint(8) unsigned DEFAULT 0,
...
) ENGINE=InnoDB AUTO_INCREMENT=492179 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `players_backup_2`
--

DROP TABLE IF EXISTS `players_backup_2`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `players_backup_2` (
  `id` int(11) unsigned NOT NULL DEFAULT 0,
  `account_id` int(11) unsigned NOT NULL,
  `name` varchar(15) NOT NULL DEFAULT '',
  `create_ident` varchar(10) NOT NULL DEFAULT '',
...
CREATE TABLE `skill_components` (
  ...
  CONSTRAINT `skill_components_ibfk_1` FOREIGN KEY (`skill_id`) REFERENCES `skills` (`id`),
  CONSTRAINT `skill_components_skills_id` FOREIGN KEY (`skill_id`) REFERENCES `skills` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `skill_forces` (
  ...
  CONSTRAINT `skill_forces_ibfk_1` FOREIGN KEY (`skill_id`) REFERENCES `skills` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `skill_forces_ibfk_2` FOREIGN KEY (`force_id`) REFERENCES `forces` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
