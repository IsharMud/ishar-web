    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('completion_message', models.CharField(help_text='Message sent to the player upon completion of the quest.', max_length=700, verbose_name='Completion Message')),
                ('min_level', models.IntegerField(help_text='Minimum level of a player that may partake in the quest.', verbose_name='Minimum Level')),
                ('max_level', models.IntegerField(help_text='Maximum level of a player that may partake in the quest.', verbose_name='Maximum Level')),
                ('repeatable', models.IntegerField(help_text='Is the quest repeatable?', verbose_name='Repeatable')),
                ('description', models.CharField(help_text='Description of the quest.', max_length=512, verbose_name='Description')),
                ('prerequisite', models.IntegerField(help_text='Prerequisite quest ID number before this quest can be done.', verbose_name='Prerequisite')),
                ('class_restrict', models.IntegerField(help_text='Player class ID number to which the quest is restricted.', verbose_name='Class Restrict')),
                ('quest_intro', models.CharField(help_text='Introduction text for the quest.', max_length=2000, verbose_name='Quest Intro')),
                ('quest_source', models.PositiveIntegerField(blank=True, help_text='Quest source.', null=True, verbose_name='Quest Source')),
                ('quest_return', models.PositiveIntegerField(blank=True, help_text='Quest return.', null=True, verbose_name='Quest Return')),
            ],
            options={
                'db_table': 'quests',
                'managed': False,
        ...
        migrations.CreateModel(
            name='QuestStep',
            fields=[
                ('step_id', models.AutoField(help_text='Quest step identification number', primary_key=True, serialize=False, verbose_name='Quest ID')),
                ('step_type', models.IntegerField(help_text='Quest step type.', verbose_name='Step Type')),
                ...
                ('mystify', models.IntegerField(help_text='Mystify Quest Step.', verbose_name='Mystify')),
                ('mystify_text', models.CharField(help_text='Mystify text for the quest step.', max_length=80, verbose_name='Mystify Text')),
            ],
            options={
